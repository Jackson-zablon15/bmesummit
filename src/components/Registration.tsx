        ...
        <form className="max-w-md mx-auto bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input type="text" id="name" name="name" required className="pl-10 pr-4 py-3 w-full rounded-lg shadow-sm border border-gray-300 focus:ring-2 focus:ring-blue-400 outline-none placeholder:text-gray-500 text-black" placeholder="Your full name" />
            </div>
          </div>
          {/* Email */}
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input type="email" id="email" name="email" required className="pl-10 pr-4 py-3 w-full rounded-lg shadow-sm border border-gray-300 focus:ring-2 focus:ring-blue-400 outline-none placeholder:text-gray-500 text-black" placeholder="you@email.com" />
            </div>
          </div>
          {/* Phone Number */}
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input type="tel" id="phone" name="phone" required className="pl-10 pr-4 py-3 w-full rounded-lg shadow-sm border border-gray-300 focus:ring-2 focus:ring-blue-400 outline-none placeholder:text-gray-500 text-black" placeholder="Your phone number" />
            </div>
          </div>
          {/* Organization */}
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input type="text" id="organization" name="organization" required className="pl-10 pr-4 py-3 w-full rounded-lg shadow-sm border border-gray-300 focus:ring-2 focus:ring-blue-400 outline-none placeholder:text-gray-500 text-black" placeholder="Your organization" />
            </div>
          </div>
          {/* Submit Button */}
